...
if _name=="__main_":
    ...
    bedrooms= col1.slider("Number of Bedrooms",max_value=10,min_value=1)
    bathrooms= col1.slider("Number of Bathrooms",max_value=10,min_value=1)
    ...
    facing=col1.selectbox("Select Facing Direction",list(Facing.keys()))
    Types=col1.selectbox("Select Type",list(Type.keys()))
    res=predict(bedrooms,bathrooms,status,size,location,facing,Types)
